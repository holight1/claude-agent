...
## 协作框架
- **通用 skill 已全局化**：architect/dispatch/task/save/restore/optimize/project-add/project-remove 在 `~/.claude/skills/`
- **新项目模板**：`~/.claude/collab-framework/`（2步部署：CHATGPT.md + code-agent/）
